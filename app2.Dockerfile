...
# https://github.com/TryGhost/Ghost/blob/2.38.0/package.json#L38
FROM node:10.4.0
...
# install exiv2 to show a user induced vulnerability
RUN apt-get update && apt-get -y install exiv2
